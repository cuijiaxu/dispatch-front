...
export default class Autofaregate extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            tData: [],
    ...
    fetchTableData = (typeId, searchFields) => {
        ...
        cFetch(serverurl+`auto/list`,{
            ...
            for (let i = 0; i < songList.length; i++) {
                console.log(songList[i].autogatestationid);
                songArray.push({
                    autogatestationid: songList[i].autogatestationid,
                    organno: songList[i].organno,
                    autofaregateno: songList[i].autofaregateno,
                    autofaregateip: songList[i].autofaregateip,
                    autofaregateport: songList[i].autofaregateport,
                    acquistopsid: songList[i].acquistopsid,
                    itemcode: songList[i].itemcode,
                    autogateposinfo: songList[i].autogateposinfo,
                    manufacturerno: songList[i].manufacturerno,
                    equiptype: songList[i].equiptype,
                    reader_no: songList[i].reader_no,
                })
            }
            this.setState({
                tData: songArray
    ...
    tableHeader = () => {
        return [{
            ...
            dataIndex: 'autofaregateno',
            title: '闸机编码',
            width: 200,
        }, {
            dataIndex: 'autofaregateip',
            title: '闸机IP',
            width: 200,
        }, {
            dataIndex: 'autofaregateport',
            title: '闸机端口',
            width: 200,
        },{
            dataIndex: 'acquistopsid',
            title: '采集站编码',
            width: 200,
        },{
            dataIndex: 'itemcode',
