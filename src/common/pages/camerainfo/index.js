    ...
    fetchTableData = (typeId, searchFields) => {
        ...
        cFetch(serverurl+`cam/list`,{
            ...
            for (let i = 0; i < songList.length; i++) {
                console.log(songList[i].camerainfoid);
                songArray.push({
                    camerainfoid: songList[i].camerainfoid,
                    cameraid: songList[i].cameraid,
                    cameraname: songList[i].cameraname,
                    cameraip: songList[i].cameraip,
                    cameraport: songList[i].cameraport,
                    createtime: songList[i].createtime,
                    createuser: songList[i].createuser,
                })
            }
            this.setState({
                tData: songArray
